        ...
        <div class="col-12">
            ...
            <div class="card card-table-border-none" id="recent-orders">
                <div class="card-header justify-content-between">
                    <h2>Show Supplier</h2>
                    <div class=" ">
                        <a href="{{ route('admin.suppliers') }}" class="btn btn-info" role="button"
                            aria-pressed="true">All Suppliers</a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <img id="logo" class="card-img-top"
                                src="{{(!empty($supplier->logo))?url('images/supplier/logo/'.$supplier->logo):url('images/noimage/images.jpg')}}"
                                style="width:220px">
                            <br>
                            <br>
                            <br>
                            ...
                            <br>
                            <img id="feature" class="card-img-top"
                                src="{{(!empty($supplier->feature_image))?url('images/supplier/featureImages/'.$supplier->feature_image):url('images/noimage/images.jpg')}}"
                                style="width:250px">
                        </div>
                        <div class="col-md-8">
                            ...
                            <span>
                                <a href="{{url('supplier/edit/'.$supplier->id)}}" class="btn btn-primary" role="button"
                                    aria-pressed="true">Edit supplier</a>
                            </span>
                            <span>
                                <a href="#" class="btn btn-danger" role="button" aria-pressed="true" data-toggle="modal"
                                    data-target="#exampleModal">Delete this Supplier!</a>
                            </span>
                        </div>
                        <hr>
                    </div>
