        ...
        <div class="col-12">
            ...
            <div class="card card-table-border-none" id="recent-orders">
                <div class="card-header justify-content-between">
                    <h2>Add Category</h2>
                    <div class=" ">
                        <a href="{{ route('admin.categories') }}" class="btn btn-info" role="button"
                    ...
                    <form class="forms-sample" method="POST" action="{{route('update.category',$category->id)}}"
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input name="feature_image" id="image" type="file" class="form-control file-upload-info"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <br>
                                <img id='output'
                                    src="{{(!empty($category->feature_image))?url('images/category/featureImages/'.$category->feature_image):url('images/noimage/images.jpg')}}"
                                    style="width: 180px">
                                <script>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea type="text" class="form-control" name="meta_description" id="meta_description"
                                    rows="">{{ $category->meta_description }}</textarea>
                            </div>
                            <div class="form-group col-md-4">
